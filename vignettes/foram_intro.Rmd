...
For example, when you use this function on other data stored as .csv, you would use this code snippet: `lf_out <- load_foram(foram_data = "path/to/your/file.csv")` instead of what is in the code chunk directly below. For this example, let's just run the chunk below using a data frame. 
